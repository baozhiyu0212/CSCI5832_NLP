...
#confusion matrix
Confusion = {}
for sysLine, goldLine in zip(system, gold):
	if not sysLine:
		continue
	if goldLine.split()[1] not in Confusion :
		Confusion[goldLine.split()[1]] = {}
	if sysLine.split()[1] not in Confusion[goldLine.split()[1]] :
		Confusion[goldLine.split()[1]][sysLine.split()[1]] = 1
	else :
		Confusion[goldLine.split()[1]][sysLine.split()[1]] += 1	
print (Confusion)
